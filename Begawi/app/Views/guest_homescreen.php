...
<head>
    ...
    <style>
        ...
        .job-item { border: 1px solid #eee; padding: 15px; margin-bottom: 15px; border-radius: 5px; }
        .job-item h2 { margin-top: 0; }
        .job-item a { text-decoration: none; color: #007bff; }
        .job-item a:hover { text-decoration: underline; }
        .auth-links { margin-bottom: 20px; }
        .auth-links a { margin-right: 15px; }
    </style>
</head>
<body>
