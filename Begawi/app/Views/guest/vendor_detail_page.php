...
<body>
    <div class="profile-container">
        <?php if (!empty($vendor)): ?>
            <?php
            $companyName = esc($vendor->company_name);
            ...
            <div class="profile-header">
                <div class="profile-logo" style="<?= $has_real_logo ? 'background-color: #fff; padding:0;' : '' ?>">
                    <?php if ($has_real_logo): ?>
                        <img src="<?= $logo_url ?>" alt="Logo <?= $companyName ?>">
                    <?php else: ?>
                        <?= esc($initials) ?>
                    <?php endif; ?>
                </div>
                            ...
                            <div class="card job-card w-100">
                                <div class="card-body d-flex flex-column">
                                    <div class="d-flex align-items-start mb-3">
                                        <div class="company-logo me-3" style="<?= $has_real_logo ? 'background-color: #fff; padding:0;' : 'background-color: #eee;' ?>">
                                            <?php if ($has_real_logo): ?>
                                                <img src="<?= $logo_url ?>" alt="Logo <?= $companyName ?>">
                                            <?php else: ?>
                                                <?= esc($initials) ?>
                        ...
                        <div class="col-md-6 d-flex align-items-stretch">
                            <div class="card job-card w-100">
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="mb-3 small flex-grow-1">
                                        <p class="job-detail-item"><i class="bi bi-geo-alt-fill"></i> <?= esc($training->location_name ?? $vendor->location_name) ?></p>
