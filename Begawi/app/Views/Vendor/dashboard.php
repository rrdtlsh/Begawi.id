...
<?= $this->section('content') ?>
    ...
    <section class="card profile-card mb-4">
        <div class="d-flex flex-column flex-sm-row align-items-start align-items-sm-center">
            <div class="flex-shrink-0 text-white d-flex align-items-center justify-content-center mb-3 mb-sm-0 me-sm-4" style="width: 80px; height: 80px; border-radius: 0.5rem; font-size: 2.5rem; font-weight: bold; background-color: var(--sasirangan-green-medium, #5d8b2f);">
                <?php 
            ...
            <div>
                ...
                <div class="mt-2 text-secondary">
                    <p class="mb-2 d-flex align-items-center"><i class="bi bi-geo-alt-fill me-2"></i> <?= esc($vendor->location_name ?? 'Lokasi belum diatur') ?></p>
                    <p class="mb-2 d-flex align-items-center"><i class="bi bi-building-fill me-2"></i> <?= esc($vendor->industry ?? 'Industri belum diatur') ?></p>
                    <p class="mb-0 d-flex align-items-center"><i class="bi bi-envelope-fill me-2"></i> <?= esc($vendor->user_email) ?></p>
                </div>
            </div>
        </div>
        <hr class="my-3">
                    ...
                    <div class="card h-100">
                        <div class="card-body posting-card d-flex flex-column">
                            ...
                            <div class="text-secondary small mb-4">
                                ...
                                <p class="mb-0"><strong>Diposting:</strong> <?= date('d M Y', strtotime($job->created_at)) ?></p>
                            </div>
                            <div class="mt-auto d-grid gap-2 d-sm-flex justify-content-center align-items-center">
                                ...
                                <form action="<?= site_url('vendor/jobs/delete/' . $job->id) ?>" method="post" onsubmit="return confirm('Apakah Anda yakin ingin menghapus lowongan ini?');">
