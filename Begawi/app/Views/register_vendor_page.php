...
<div class="registration-container">
    ...
    <div class="input-group">
        ...
        <input type="text" id="company_name" name="company_name" placeholder="Contoh: PT. Jaya Abadi"
            value="<?= esc(old('company_name')) ?>" required>
    </div>

    <div class="input-group">
        <label for="industry">Bidang Kategori Jasa</label>
        <input type="text" id="industry" name="industry" placeholder="Contoh: Teknologi Informasi"
            value="<?= esc(old('industry')) ?>" required>
    </div>
    ...
    <div class="input-group">
        ...
        <textarea id="company_address" name="company_address" placeholder="Contoh: Jl. A. Yani Km. 5, Gedung ABC Lt. 2"
            required><?= esc(old('company_address')) ?></textarea>
    </div>

    <div class="input-group">
        <label for="contact">Nomor Telepon / WhatsApp</label>
        <input type="text" id="contact" name="contact" placeholder="Contoh: 081234567890"
